...
CREATE INDEX ix_edge_fact_course ON edge_runner_fact(venue_code, surface_code, distance_m, turn_code, frame_zone);
CREATE INDEX ix_edge_fact_sire ON edge_runner_fact(sire_name, race_date);
CREATE INDEX ix_edge_fact_sire_line ON edge_runner_fact(sire_line_code, race_date);

...
-- JRDB Analysis Lite schema v1.1
-- v1.0 compatibility note:
--   condition_code was ambiguous and actually represented race condition/class.
-- v1.1 renames it to race_condition_code and adds actual track condition plus frame_no.
